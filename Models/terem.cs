...
public class Terem
{
	...
	private void sort_seats_into_local_array(byte[] x, byte[] y, byte[] value)
	{
		try
		{
            ...
            {
                throw new Exception("Failed to read and sort seats into local array.");
            }
        }
		catch (Exception e)
		{ 
